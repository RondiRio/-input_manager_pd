...
// PT-BR: Controlador REST para produtos. Mesma abordagem do RawMaterialResource --
//        delegamos tudo ao service e mantemos o controller enxuto.
// EN-US: REST controller for products. Same approach as RawMaterialResource --
//        we delegate everything to the service and keep the controller lean.
@Path("/api/products")
